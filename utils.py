...
class GUI():
    ...
    def common_config(self, title='Dashboard '): #(Beta version :golf:)
        ...
        """
        st.image("./test_images/cat.jpg","KITTY", width=50)
    ...
    def appDescription(self):
        ...
        if self.selectedApp == 'Object Detection':
            ...
            st.info(
                'To start using dashboard you must first select an Application from the sidebar menu other than Empty')
...
class DataManager:
    ...
    def __init__(self, guiParam):
        ...
        self.demo_image_examples = {"Family-picture": "./test_images/family.jpg",
                                    "Fire": "./test_images/fire.jpg",
                                    "Dog": "./test_images/dog.jpg",
                                    "Crosswalk": "./test_images/demo.jpg",
                                    "Cat": "./test_images/cat.jpg",
                                    "Car on fire": "./test_images/car_on_fire.jpg"}
